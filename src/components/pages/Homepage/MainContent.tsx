...
const MainContent = ({ setSelected }: { setSelected: React.Dispatch<React.SetStateAction<number>> }) => {
	...
	return (
		<article className="w-[100vw] lg:w-2/3 pb-24  h-auto overflow-x:hidden  backdrop-blur">
			<div className="p-4 w-full max-w-[760px] mr-auto px-6">
				...
				<section className="w-[95%] overflow-hidden h-auto py-6 my-6 lg:py-14 lg:my-14" id="experience" ref={experienceRef}>
					...
					<a href="/resume.pdf" target="_blank" className="font-clash font-medium capitalize text-white2 hover:text-sec">
						View full Resume
				...
				<section className="overflow-hidden overflow-y-auto w-full h-auto py-6 my-6 lg:py-14 lg:my-14" id="projects" ref={projectsRef}>
					...
					<div className="my-3 mb-6">
						<p className="px-2">
							<span className="font-bold text-sec">NB </span>: Some projects are using free hosting hence will take some time for the content to fully load. Please wait around for
