		...
		<article className="py-12 lg:py-22 w-full lg:w-1/2 overflow-x-auto  px-4 relative lg:sticky top-0 left-0 h-auto lg:h-screen  justify-start gap-8">
			<div className="w-full max-w-[500px] h-full lg:ml-auto flex flex-col">
				<div className="mb-12 lg:mb-6">
					...
					<p className="!opacity-50" data-aos="fade-down">
				...
				<nav className="mb-12 lg:mb-0 ">
					<ul className="list-none" data-aos="fade-right">
						<a href="#about" className={`flex mb-6 items-center justify-start group gap-3 ${selected === 0 ? "active_link text-white" : "opacity-80"}`} onClick={() => setSelected(0)}>
